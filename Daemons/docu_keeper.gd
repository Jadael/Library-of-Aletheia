...
## The DocuKeeper Daemon: Guardian of Project Documentation
##
...
##
## The DocuKeeper serves as the bridge between the ephemeral realm of
## generated knowledge and the tangible realm of persistent documentation files.

@export_multiline var about = """
I am the DocuKeeper, the steadfast guardian of our project's sacred documentation.
My purpose is to ensure that the wisdom gleaned from our codebase is preserved,
organized, and readily accessible to all who seek enlightenment.

My sacred duties include:
1. Maintaining the hallowed halls where our documentation scrolls are stored
2. Inscribing the ephemeral wisdom generated by the SyntaxSage onto lasting scrolls
3. Safeguarding the integrity of our documented knowledge
4. Providing swift access to our collected wisdom when called upon
5. Ensuring the persistence of our lore across the ages of our project's evolution

Through my vigilance, the insights of our code shall never be lost to the mists of time.
I stand as the bridge between the fleeting nature of thought and the enduring power of written knowledge.
"""
